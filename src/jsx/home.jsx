...
*/
  hrefGames() {
    this.refs.games.className = 'nav animated shake';
    setTimeout(() => {
      this.refs.home.className= 'home animated bounceOutRight';
      setTimeout(() => {
...
*/
  hrefNotes() {
    this.refs.article.className = 'nav animated shake';
    setTimeout(() => {
      this.refs.home.className= 'home animated bounceOutRight';
      setTimeout(() => {
...
*/
  cardsAction(action) {
    if (action) {
      ...
      this.refs.games.style.display = 'block';
      ...
      this.refs.games.style.display = 'none';
