						...
						<div ref='promote'
							...
							<h3>
								{this.state.language === 'Cn'
									...
									: 'There are lots of key ponits of React that we could talk around, have a rest and then go on next time?'
								}
							</h3>
							<div ref='backIcon'
									 className='back-icon'
