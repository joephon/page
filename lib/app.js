			...
			value: function avatarClick() {
				...
				if (this.state.press) {
					...
					if (this.refs.avatar.className === 'avatar') {
						...
						setTimeout(function () {
							_this3.setState({ text: text[2], isNav: true });
							_this3.refs.light.style.left = '1500px';
							_this3.refs.round.style.transform = 'rotate(360deg)';
							_this3.refs.profile.style.display = 'block';
							_this3.refs.article.style.display = 'block';
							_this3.refs.game.style.display = 'block';
							_this3.refs.present.style.display = 'block';
						}, 2000);
					} else {
						...
						setTimeout(function () {
							_this3.refs.round.style.transform = 'rotate(0deg)';
						}, 2000);
					}
					setTimeout(function () {
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement('img', { src: '../src/image/joe.png' })
								)
							),
							_react2.default.createElement(
								'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./nav.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./nav.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./profile.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./profile.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
