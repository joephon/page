...
/***/ function(module, exports, __webpack_require__) {
	...
	var text = ['People come, people go, people never ever need to know. Welcome to my tiny site, it\'s powered by React and NodeJs. looks a kinda weird right? I dont act it as a simple site, it contains every single thought that I feel like to toss. press the right side buttom to know more if interested : )', '人来人往，人去楼空；梦来梦去，水过竹笼。荣幸歇脚小站，搭建小站我用了React和NodeJs，颜色偏好灰白。大概看起来有点奇葩，不像个站，但我喜欢，喜欢各种折腾，各种鼓捣，小站虽葩，却承载着我无穷无尽的奇思小想。戳左边按钮切换语言，戳右边按钮了解更多: )', 'Well here we are! the above displayed cards are the main navigators which may lead you to any corner of my tiny world! Typecally, something was hidden under the page, I have it buried since the site was bulit. it may not be any secrets but can be some funny things. Want to dig it up? pick up a card and take forward. : )', '有没有搞错哦！'];
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'dress3' },
									'Joephon, a self-culture programmer. click to get more.'
								)
							),
							_react2.default.createElement(
								'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'dress3' },
									'No pain no gain, no game no boom! go get boom~'
								)
							)
						),
						_react2.default.createElement(
