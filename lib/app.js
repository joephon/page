...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".home {\n  width: 100%;\n  height: 100%; }\n  .home .container {\n    position: relative;\n    overflow: hidden;\n    width: 100%;\n    height: 100%; }\n    .home .container .round {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      width: 160px;\n      height: 160px;\n      margin-top: -80px;\n      margin-left: -80px;\n      border-radius: 50%;\n      transform: rotate(0deg);\n      transition: all 3s ease-in-out; }\n      .home .container .round .glyphicon {\n        margin-left: -39px;\n        line-height: 160px;\n        font-size: 240px; }\n    .home .container .avatar {\n      overflow: hidden;\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      width: 250px;\n      height: 250px;\n      margin-top: -125px;\n      margin-left: -125px;\n      border-radius: 50%;\n      background-color: #edc146;\n      cursor: pointer;\n      transform: scale(1);\n      transition: all 0.2s ease-in-out; }\n    .home .container .avatar-click {\n      overflow: hidden;\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      width: 250px;\n      height: 250px;\n      margin-top: -125px;\n      margin-left: -125px;\n      border-radius: 50%;\n      background-color: #B2EBF2;\n      cursor: pointer;\n      transform: scale(0.5);\n      transition: all 0.2s ease-in-out; }\n    .home .container .avatar .pic, .home .container .avatar-click .pic {\n      opacity: 0;\n      width: 250px;\n      height: 250px;\n      border-radius: 50%;\n      transition: all 0.5s ease-in-out; }\n      .home .container .avatar .pic img, .home .container .avatar-click .pic img {\n        width: 100%;\n        border-radius: 50%; }\n    .home .container .skill {\n      position: absolute;\n      top: 48%;\n      left: 45%;\n      font-size: 30px;\n      color: #f5f5f5;\n      transition: all 6s ease-in-out; }\n", ""]);
