...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mAd = __webpack_require__(257);

	var _mAd2 = _interopRequireDefault(_mAd);

	var _mHome = __webpack_require__(231);
		...
		_createClass(Ad, [{
			...
			value: function textMove() {
				...
				setTimeout(function () {
					...
					_this5.refs.text2.style.color = 'rgba(171,53,19,.9)';
					_this5.refs.text2.style.textShadow = '1px 1px 60px red';
				}, 4100);
			}
		}, {
			key: 'icon',
			...
			value: function iconStep1() {
				...
				setTimeout(function () {
					...
					_this6.refs.icon.style.boxShadow = '1px 1px 50px red';
				}, 2800);
			}
		}, {
			key: 'iconStep2',
