...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apps = __webpack_require__(242);

	var _apps2 = _interopRequireDefault(_apps);

	var _helloReact = __webpack_require__(247);
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: 'app/helloReact', component: _helloReact2.default })
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var text = ['People leave, people go, people never ever need to know. Welcome to my tiny site, it\'s powered by React and NodeJs. looks a kinda weird right? I dont act it as a simple site, it contains every single thought that I feel like to toss. The above listed are all my skills, press the right side buttom to know more if interested : )', '人来人往，人去楼空；梦遂梦毁，梦不旋踵。荣幸歇脚小站，搭建小站我用了React和NodeJs，颜色偏好灰白。大概看起来有点奇葩，不过没关系，我喜欢就好。爱折腾，好鼓捣，此处俨然成了在下胡作非为的小天地，并承载着我无穷无尽的奇思怪想。上面吊着的一串串乃鄙人涉猎范围，戳左边按钮切换语言，戳右边按钮了解更多: )', 'Well here we are! the above displayed cards are the main navigators which may lead you to any corner of my tiny world! Typecally, something was hidden under the page, I have it buried since the site was bulit. it may not be any secrets but can be some funny things. Want to dig it up? pick up a card and take forward. : )', '帅哥，别来无恙！人生苍茫而苦短，码海八嘎(bug)且无岸。今有幸萍水相逢，如浴春风，莫笑我站蓬荜多(灰)，然则黑白方为永恒之主题。崇尚简约风格，故这里不会有闲杂div等，但～也许会有古灵精怪的东西出现或者匪夷所思的事情发生。。。。。。不管怎样，那都是无害的。上面是几个主要入口，闲着没事，走走逛逛呗 : )'];
	...
	var framework = document.getElementsByClassName('framework');
	...
	var Home = (function (_React$Component) {
	  ...
	  */
			...
			value: function cols() {
				for (var i = 0; i < col.length; i++) {
					...
					tip[i].style.transform = Math.random() >= 0.5 ? 'rotate(' + Math.random() * 20 + 'deg)' : 'rotate(' + Math.random() * -20 + 'deg)';
				}
			}
	  ...
	  */
			...
			value: function hrefProfile() {
				...
				setTimeout(function () {
					_this2.refs.home.className = 'home animated bounceOutRight';
					setTimeout(function () {
	  ...
	  */
			...
			key: 'hrefPresent',
			value: function hrefPresent() {
				var _this3 = this;

				this.refs.present.className = 'nav animated shake';
				setTimeout(function () {
					_this3.refs.home.className = 'home animated bounceOutRight';
					setTimeout(function () {
	  ...
	  */
			...
			key: 'textLanguage',
			value: function textLanguage() {
				if (this.state.isNav) {
					this.state.text === text[2] ? this.setState({ text: text[3] }) : this.setState({ text: text[2] });
				} else if (!this.state.isNav) {
					this.state.text === text[0] ? this.setState({ text: text[1] }) : this.setState({ text: text[0] });
				}
			}
	  ...
	  */
			...
			key: 'avatarHover',
			value: function avatarHover() {
				if (this.refs.avatar.className !== 'avatar-click') {
					this.refs.avatar.className === 'avatar' ? this.refs.avatar.className = 'avatar animated infinite pulse' : this.refs.avatar.className = 'avatar';
				}
			}
	  ...
	  */
			...
			key: 'colsAction',
			value: function colsAction(action) {
				if (action) {
	  ...
	  */
			...
			key: 'skillsAction',
			value: function skillsAction(action) {
				if (action) {
	  ...
	  */
			...
			key: 'panelAction',
			value: function panelAction(action) {
				if (action) {
	  ...
	  */
			...
			key: 'cardsAction',
			value: function cardsAction(action) {
				if (action) {
	  ...
	  */
			...
			value: function avatarClick() {
				...
				if (this.state.press) {
					...
					setTimeout(function () {
						return _this4.setState({ press: true });
					}, 2500);
				}
			}
		}, {
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ ref: 'home', className: 'home animated rollIn' },
					_react2.default.createElement(
						'div',
						{ className: 'container' },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'dress0' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-hand-right' })
								),
								_react2.default.createElement('div', { className: 'dress1' }),
								_react2.default.createElement(
									'div',
									{ className: 'dress2' },
							...
							_react2.default.createElement(
								'div',
								{ ref: 'article', className: 'nav animated flipInY' },
								_react2.default.createElement(
									'div',
									{ className: 'dress0' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-hand-right' })
							...
							_react2.default.createElement(
								'div',
								{ ref: 'game', className: 'nav animated flipInY' },
								_react2.default.createElement(
									'div',
									{ className: 'dress0' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-hand-right' })
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'tip' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-tower' }),
									'Frameworks'
								),
								_react2.default.createElement(
									'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('div', { className: 'global-back' }),
							_react2.default.createElement('div', { className: 'round-back' }),
							_react2.default.createElement(
								'div',
								{ ref: 'global', className: 'global', onMouseOver: this.textLanguage.bind(this) },
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-globe' })
							),
							_react2.default.createElement(
								'div',
								{ ref: 'round', className: 'round' },
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'pointer' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-hand-up' })
								),
								_react2.default.createElement(
									'div',
									{ ref: 'pic', className: 'pic' },
									_react2.default.createElement('img', { src: 'image/joe.png' })
								)
							),
							_react2.default.createElement(
								'div',
								{ ref: 'text', className: 'text' },
								this.state.text
							),
							_react2.default.createElement('div', { ref: 'light', className: 'light' })
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./home.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./home.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".home {\n  width: 100%;\n  height: 100%; }\n  .home .container {\n    position: relative;\n    overflow: hidden;\n    width: 100%;\n    height: 100%; }\n    .home .container .panel {\n      position: absolute;\n      height: 160px;\n      left: 50%;\n      bottom: 0;\n      padding: 20px 200px 20px 200px;\n      border-radius: 8px;\n      background-color: rgba(0, 0, 0, 0.5); }\n      @media (max-width: 1440px) {\n        .home .container .panel {\n          width: 1220px;\n          margin-left: -610px; } }\n      @media (max-width: 1280px) {\n        .home .container .panel {\n          width: 1220px;\n          margin-left: -610px; } }\n      @media (max-width: 1024px) {\n        .home .container .panel {\n          width: 920px;\n          margin-left: -460px; } }\n      @media (max-width: 768px) {\n        .home .container .panel {\n          width: 710px;\n          margin-left: -355px; } }\n      .home .container .panel .light {\n        position: absolute;\n        left: -1500px;\n        top: 0;\n        width: 1000px;\n        height: 160px;\n        box-shadow: 1px 1px 200px #39a30e;\n        background-color: rgba(57, 163, 14, 0.3);\n        transition: all 0.3s ease-in-out; }\n      .home .container .panel .text {\n        text-indent: 2em;\n        font-size: 20px;\n        color: #f5f5f5; }\n        @media (max-width: 768px) {\n          .home .container .panel .text {\n            font-size: 13px; } }\n      .home .container .panel .global-back {\n        position: absolute;\n        top: -35px;\n        left: -55px;\n        width: 230px;\n        height: 230px;\n        border-radius: 50%;\n        background-color: #eee; }\n      .home .container .panel .global {\n        position: absolute;\n        bottom: 5px;\n        left: 5px;\n        width: 150px;\n        height: 150px;\n        line-height: 150px;\n        font-size: 150px;\n        border-radius: 50%;\n        color: #777;\n        cursor: pointer;\n        -webkit-transform: rotate(0deg);\n                transform: rotate(0deg);\n        transition: all 0.3s ease-in-out; }\n        .home .container .panel .global:hover {\n          color: #2db7f5; }\n      .home .container .panel .round-back {\n        position: absolute;\n        top: -35px;\n        right: -55px;\n        width: 230px;\n        height: 230px;\n        border-radius: 50%;\n        background-color: #eee; }\n      .home .container .panel .round {\n        position: absolute;\n        bottom: 10px;\n        right: 10px;\n        width: 140px;\n        height: 140px;\n        line-height: 140px;\n        font-size: 140px;\n        border-radius: 50%;\n        color: #777;\n        -webkit-transform: rotate(0deg);\n                transform: rotate(0deg);\n        transition: all 1s ease-in-out; }\n        .home .container .panel .round:hover {\n          color: #FFA5B4; }\n      .home .container .panel .avatar {\n        overflow: hidden;\n        position: absolute;\n        bottom: 5px;\n        right: 5px;\n        width: 150px;\n        height: 150px;\n        margin-top: -125px;\n        margin-left: -125px;\n        border: 15px solid rgba(255, 255, 255, 0.5);\n        border-radius: 50%;\n        background-color: #777;\n        cursor: pointer;\n        -webkit-transform: scale(1);\n                transform: scale(1);\n        transition: all 0.2s ease-in-out; }\n        .home .container .panel .avatar:hover {\n          background-color: #FFA5B4; }\n        .home .container .panel .avatar .pointer {\n          padding: 40px;\n          font-size: 30px;\n          text-align: center;\n          color: #f5f5f5; }\n      .home .container .panel .avatar-click {\n        overflow: hidden;\n        position: absolute;\n        bottom: 5px;\n        right: 5px;\n        width: 150px;\n        height: 150px;\n        margin-top: -125px;\n        margin-left: -125px;\n        border-radius: 50%;\n        cursor: pointer;\n        -webkit-transform: scale(0.5);\n                transform: scale(0.5);\n        transition: all 0.2s ease-in-out; }\n      .home .container .panel .avatar .pic, .home .container .panel .avatar-click .pic {\n        opacity: 0;\n        position: absolute;\n        bottom: 0;\n        width: 150px;\n        height: 150px;\n        border-radius: 50%;\n        transition: all 0.5s ease-in-out; }\n        .home .container .panel .avatar .pic img, .home .container .panel .avatar-click .pic img {\n          width: 100%;\n          height: 100%;\n          border-radius: 50%; }\n    .home .container .col-wrap {\n      position: relative; }\n      @media (max-width: 1440px) {\n        .home .container .col-wrap {\n          width: 900px;\n          margin: 0 auto; } }\n      @media (max-width: 1280px) {\n        .home .container .col-wrap {\n          width: 900px;\n          margin: 0 auto; } }\n      @media (max-width: 1024px) {\n        .home .container .col-wrap {\n          width: 900px;\n          margin: 0 auto; } }\n      @media (max-width: 768px) {\n        .home .container .col-wrap {\n          width: 720px;\n          margin: 0 auto; } }\n      .home .container .col-wrap .col {\n        position: absolute;\n        top: -10px;\n        left: 0;\n        width: 20px;\n        height: 450px;\n        border-radius: 10px;\n        background-color: #333;\n        transition: all 0.5s ease-in-out; }\n        .home .container .col-wrap .col .tip {\n          position: absolute;\n          left: -40px;\n          bottom: 15px;\n          width: 100px;\n          height: 30px;\n          border-radius: 15px;\n          line-height: 30px;\n          text-align: center;\n          font-size: 10px;\n          background-color: #39a30e; }\n          .home .container .col-wrap .col .tip .glyphicon {\n            margin-right: 5px; }\n        .home .container .col-wrap .col .skill {\n          position: absolute;\n          top: 0;\n          left: -50px;\n          width: 130px;\n          padding: 5px;\n          border-radius: 5px;\n          text-align: center;\n          font-size: 14px;\n          color: #f5f5f5;\n          background-color: rgba(0, 0, 0, 0.5); }\n        .home .container .col-wrap .col .backend, .home .container .col-wrap .col .frontend, .home .container .col-wrap .col .db, .home .container .col-wrap .col .framework, .home .container .col-wrap .col .lib, .home .container .col-wrap .col .tool {\n          position: absolute;\n          top: 0;\n          left: -50px; }\n    @media (max-width: 1440px) {\n      .home .container .nav-wrap {\n        width: 1220px;\n        margin: 0 auto; } }\n    @media (max-width: 1280px) {\n      .home .container .nav-wrap {\n        width: 1220px;\n        margin: 0 auto; } }\n    @media (max-width: 1024px) {\n      .home .container .nav-wrap {\n        width: 920px;\n        margin: 0 auto; } }\n    @media (max-width: 768px) {\n      .home .container .nav-wrap {\n        width: 610px;\n        margin: 0 auto; } }\n    .home .container .nav-wrap .nav {\n      display: none;\n      float: left;\n      position: relative;\n      width: 285px;\n      height: 200px;\n      margin-top: 20px;\n      margin-right: 20px;\n      border-radius: 5px;\n      background-color: #777;\n      cursor: pointer; }\n      .home .container .nav-wrap .nav:hover {\n        box-shadow: 3px 3px 8px #888; }\n      .home .container .nav-wrap .nav:hover .dress0 {\n        opacity: 0;\n        left: 100px; }\n      .home .container .nav-wrap .nav:hover .dress2 {\n        -webkit-transform: rotateY(180deg);\n                transform: rotateY(180deg);\n        -webkit-transform-origin: left;\n                transform-origin: left; }\n      .home .container .nav-wrap .nav:hover .dress3 {\n        opacity: 1; }\n      .home .container .nav-wrap .nav .dress0 {\n        position: absolute;\n        top: 30px;\n        left: 30px;\n        padding: 40px 36px 40px 36px;\n        font-size: 40px;\n        text-align: center;\n        color: #f5f5f5;\n        transition: all 0.5s ease-in-out; }\n      .home .container .nav-wrap .nav .dress1 {\n        position: absolute;\n        top: 10px;\n        left: 10px;\n        width: 15px;\n        height: 15px;\n        border-radius: 50%;\n        background-color: #eee; }\n      .home .container .nav-wrap .nav .dress2 {\n        position: absolute;\n        top: 30px;\n        right: 30px;\n        padding: 40px 36px 40px 36px;\n        border-radius: 5px;\n        font-size: 40px;\n        text-align: center;\n        color: #f5f5f5;\n        background-color: #999;\n        transition: all 0.5s ease-in-out; }\n      .home .container .nav-wrap .nav .dress3 {\n        opacity: 0;\n        position: absolute;\n        top: 30px;\n        right: 30px;\n        width: 110px;\n        height: 137px;\n        padding: 10px;\n        border-radius: 5px;\n        font-size: 16px;\n        text-align: center;\n        color: #444;\n        background-color: #999;\n        transition: all 0.5s ease-in-out; }\n", ""]);
	...
	var Profile = (function (_React$Component) {
		...
		function Profile(props) {
			...
			_this.state = {
				...
				section: null,
				// main: this.mainText(),
				hrefAnimation: function hrefAnimation() {
					_this.refs.profile.className = 'profile animated bounceOutLeft';
				}
			};
			return _this;
		}
		...
		_createClass(Profile, [{
			...
			value: function componentDidMount() {
				...
				setTimeout(function () {
					return _this2.showSections();
				}, 400);
			}
		}, {
			key: 'showSections',
			value: function showSections() {
				var _this3 = this;
				...
				var _loop = function _loop(i) {
					setTimeout(function () {
						...
						window.innerWidth <= 768 + 'px' ? section[i].style.marginRight = '-400px' : section[i].style.marginRight = '-300px';
						setTimeout(function () {
							content[i].style.display = 'block';
							section[i].style.transform = 'rotate(' + i * 20 + 'deg)';
							_this3.refs.main.className = 'section';
						}, 800);
					}, i * 200);
				};
			...
			value: function _switch(event) {
				...
				this.setState({ info: info }, function () {
					if (_this4.state.translate) {
						_this4.setState({ translate: false, en: _this4.state.en ? false : true }, function () {
							if (_this4.state.en) {
								_this4.refs.button.style.boxShadow = 'none';
								_this4.refs.switch.style.backgroundColor = '#999';
								_this4.refs.button.style.right = '20px';
								_this4.refs.button.style.backgroundColor = '#fff';
							} else {
								_this4.refs.button.style.boxShadow = '1px 1px 20px rgb(45,183,245)';
								_this4.refs.switch.style.backgroundColor = 'rgba(45,183,245,.5)';
								_this4.refs.button.style.right = 0;
								_this4.refs.button.style.backgroundColor = 'rgb(45,183,245)';
							}
						});
						setTimeout(function () {
							_this4.setState({ translate: true });
						}, 500);
					}
				});
			}
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ ref: 'profile', className: 'profile animated bounceInLeft' },
					_react2.default.createElement(
						'div',
						{ className: 'container' },
						_react2.default.createElement(
							'div',
							{ className: 'body' },
							_react2.default.createElement('div', { ref: 'black', className: 'black', onClick: this.hideBlack.bind(this) }),
							_react2.default.createElement(
								'div',
								{ ref: 'main',
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'div',
										{ ref: this.state.info == 'main' ? 'switch' : null, className: 'switch' },
										_react2.default.createElement('div', { ref: this.state.info == 'main' ? 'button' : null, className: 'button', 'data-info': 'main', onMouseOver: this.switch.bind(this) })
									),
									_react2.default.createElement(
										'div',
										{ className: 'details' },
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'div',
										{ ref: this.state.info == 'skill' ? 'switch' : null, className: 'switch' },
										_react2.default.createElement('div', { ref: this.state.info == 'skill' ? 'button' : null, className: 'button', 'data-info': 'skill', onMouseOver: this.switch.bind(this) })
									),
									_react2.default.createElement(
										'div',
										{ className: 'details' },
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'div',
										{ ref: this.state.info == 'plan' ? 'switch' : null, className: 'switch' },
										_react2.default.createElement('div', { ref: this.state.info == 'plan' ? 'button' : null, className: 'button', 'data-info': 'plan', onMouseOver: this.switch.bind(this) })
									),
									_react2.default.createElement(
										'div',
										{ className: 'details' },
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'div',
										{ ref: this.state.info == 'hobby' ? 'switch' : null, className: 'switch' },
										_react2.default.createElement('div', { ref: this.state.info == 'hobby' ? 'button' : null, className: 'button', 'data-info': 'hobby', onMouseOver: this.switch.bind(this) })
									),
									_react2.default.createElement(
										'div',
										{ className: 'details' },
						...
						_react2.default.createElement(_nav2.default, { title: 'Profile', hrefAnimation: this.state.hrefAnimation })
					)
				);
			}
		}]);
		...
		_createClass(Nav, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ ref: 'back', className: 'back', onClick: this.hrefBack.bind(this) },
					...
					_react2.default.createElement(
						'div',
						{ ref: 'menu', className: 'menu', onClick: this.rightNav.bind(this) },
						_react2.default.createElement('span', { className: 'glyphicon glyphicon-option-vertical' })
					),
					_react2.default.createElement('div', { ref: 'blackBoard', className: 'black-board', onClick: this.rightNav.bind(this) }),
					_react2.default.createElement(
						'div',
						{ ref: 'menuList', className: 'menu-list' },
						_react2.default.createElement(
							'div',
							{ className: 'avatar' },
							_react2.default.createElement('img', { src: 'image/joe.png' })
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./nav.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./nav.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".nav {\n  z-index: 102;\n  width: 100%;\n  height: 60px;\n  background-color: transparent;\n  transition: all 0.3s ease-in-out; }\n  @media (max-width: 768px) {\n    .nav {\n      height: 40px; } }\n  .nav:hover {\n    background-color: rgba(0, 0, 0, 0.9); }\n  .nav:hover .back, .nav:hover .menu {\n    color: #f5f5f5; }\n  .nav .back {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 60px;\n    height: 60px;\n    line-height: 60px;\n    text-align: center;\n    font-size: 30px;\n    color: #777;\n    cursor: pointer;\n    transition: all 0.3s ease-in-out; }\n    @media (max-width: 768px) {\n      .nav .back {\n        height: 40px;\n        line-height: 40px;\n        font-size: 20px; } }\n    .nav .back:hover {\n      color: #2db7f5; }\n  .nav h4 {\n    margin: 0;\n    color: #eee;\n    line-height: 60px;\n    text-align: center; }\n    @media (max-width: 768px) {\n      .nav h4 {\n        line-height: 40px;\n        font-size: 16px; } }\n  .nav .black-board {\n    display: none;\n    position: absolute;\n    top: 0;\n    right: 0;\n    width: 100%;\n    background-color: rgba(0, 0, 0, 0.8);\n    cursor: pointer; }\n  .nav .menu {\n    position: absolute;\n    top: 0;\n    right: 0;\n    width: 60px;\n    height: 60px;\n    line-height: 60px;\n    text-align: center;\n    font-size: 30px;\n    color: #777;\n    cursor: pointer;\n    transition: all 0.3s ease-in-out; }\n    @media (max-width: 768px) {\n      .nav .menu {\n        height: 40px;\n        line-height: 40px;\n        font-size: 20px; } }\n    .nav .menu:hover {\n      color: #2db7f5; }\n  .nav .menu-list {\n    position: absolute;\n    top: 0;\n    right: -300px;\n    width: 300px;\n    height: 160px;\n    background-color: #fff;\n    transition: all 0.2s ease-in-out; }\n    .nav .menu-list .avatar {\n      overflow: hidden;\n      width: 125px;\n      height: 125px;\n      margin: 30px auto 5px auto;\n      border-radius: 50%; }\n      .nav .menu-list .avatar img {\n        width: 100%;\n        height: 100%; }\n    .nav .menu-list h3 {\n      margin: 0;\n      padding: 0;\n      text-align: center;\n      color: #555; }\n    .nav .menu-list p {\n      margin: 0;\n      padding: 0;\n      text-align: center;\n      color: #777; }\n    .nav .menu-list .href {\n      width: 300px;\n      height: 60px;\n      line-height: 60px;\n      text-align: center;\n      font-size: 20px;\n      cursor: pointer; }\n      .nav .menu-list .href:hover {\n        background-color: #f5f5f5; }\n      .nav .menu-list .href span {\n        margin-left: 20px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./profile.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./profile.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".profile {\n  width: 100%;\n  height: 100%; }\n  .profile .container {\n    position: relative;\n    overflow: hidden;\n    width: 100%;\n    height: 100%; }\n    .profile .container .body {\n      position: relative; }\n      .profile .container .body .black {\n        display: none;\n        position: absolute;\n        top: 0;\n        left: 0;\n        background-color: rgba(0, 0, 0, 0.8);\n        cursor: pointer; }\n      .profile .container .body .section-picked {\n        z-index: 100;\n        top: 100px !important;\n        right: 50%;\n        margin-right: -500px !important;\n        width: 1000px !important;\n        height: 600px !important;\n        border-right: none !important;\n        background-color: #eee !important;\n        -webkit-transform: rotate(0deg) !important;\n                transform: rotate(0deg) !important;\n        transition: all 0.2s ease-in-out !important; }\n        @media (max-width: 768px) {\n          .profile .container .body .section-picked {\n            width: 700px !important;\n            margin-right: -350px !important; } }\n      .profile .container .body .section-hover {\n        transition: all 0.2s ease-in-out !important; }\n      .profile .container .body .section-shadow {\n        box-shadow: 3px 3px 80px #2db7f5; }\n      .profile .container .body .section {\n        overflow: hidden;\n        position: absolute;\n        right: -800px;\n        width: 600px;\n        height: 200px;\n        border-right: 2px solid #999;\n        border-radius: 5px;\n        background-color: #ccc;\n        cursor: pointer;\n        -webkit-transform-origin: left top;\n                transform-origin: left top;\n        transition: all 0.5s ease-in-out; }\n        @media (max-width: 768px) {\n          .profile .container .body .section {\n            width: 500px; } }\n        .profile .container .body .section:hover .header {\n          background-color: #2db7f5; }\n        .profile .container .body .section .header {\n          position: relative;\n          width: 100%;\n          height: 40px;\n          line-height: 40px;\n          text-align: center;\n          color: #f5f5f5;\n          background-color: #999;\n          transition: all 0.3s ease-in-out; }\n          .profile .container .body .section .header .dress1 {\n            position: absolute;\n            left: 15px;\n            top: 10px;\n            width: 15px;\n            height: 15px;\n            border-radius: 50%;\n            background-color: #eee; }\n          .profile .container .body .section .header .dress2 {\n            position: absolute;\n            right: 15px;\n            top: 10px;\n            width: 20px;\n            height: 20px;\n            text-align: center;\n            line-height: 20px;\n            font-size: 18px;\n            color: #eee; }\n        .profile .container .body .section .content {\n          position: relative; }\n          .profile .container .body .section .content .switch {\n            position: absolute;\n            top: 20px;\n            right: 20px;\n            width: 40px;\n            height: 10px;\n            border-radius: 10px;\n            background-color: #999;\n            transition: all 0.3s ease-in-out; }\n            .profile .container .body .section .content .switch .button {\n              position: absolute;\n              top: -5px;\n              right: 20px;\n              width: 20px;\n              height: 20px;\n              border-radius: 50%;\n              background-color: #fff;\n              transition: all 0.3s ease-in-out; }\n          .profile .container .body .section .content .details {\n            padding: 40px 60px 40px 60px;\n            font-size: 20px; }\n            @media (max-width: 768px) {\n              .profile .container .body .section .content .details {\n                font-size: 14px; } }\n            .profile .container .body .section .content .details .sentence {\n              margin-top: 20px;\n              text-indent: 2em;\n              color: #777; }\n            .profile .container .body .section .content .details .language {\n              height: 25px;\n              line-height: 25px;\n              margin-bottom: 10px;\n              border-radius: 5px;\n              text-align: center;\n              font-size: 14px;\n              background-color: rgba(45, 183, 245, 0.5); }\n            .profile .container .body .section .content .details .ruby {\n              width: 20%; }\n            .profile .container .body .section .content .details .node {\n              width: 30%; }\n            .profile .container .body .section .content .details .linux {\n              width: 40%; }\n            .profile .container .body .section .content .details .javascript {\n              width: 55%; }\n            .profile .container .body .section .content .details .html {\n              width: 90%; }\n            .profile .container .body .section .content .details .css {\n              width: 80%; }\n            .profile .container .body .section .content .details .express {\n              width: 75%; }\n            .profile .container .body .section .content .details .rails {\n              width: 45%; }\n            .profile .container .body .section .content .details .react {\n              width: 90%; }\n            .profile .container .body .section .content .details .react-native {\n              width: 75%; }\n            .profile .container .body .section .content .details .mysql {\n              width: 45%; }\n            .profile .container .body .section .content .details .mongodb {\n              width: 35%; }\n            .profile .container .body .section .content .details .jquery {\n              width: 70%; }\n            .profile .container .body .section .content .details .bootstrap {\n              width: 65%; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Apps = (function (_React$Component) {
			...
			function Apps(props) {
					...
					_this.state = {
							hrefAnimation: function hrefAnimation() {
									_this.refs.apps.className = 'apps animated bounceOutLeft';
							}
					};
					return _this;
			}
			...
			_createClass(Apps, [{
					...
					key: 'showApps',
					value: function showApps(row1s, row2s, i) {
							setTimeout(function () {
					...
					key: 'showFlash',
					value: function showFlash(row1s, row2s, i) {
							setTimeout(function () {
					...
					value: function boxShadow() {
							...
							setTimeout(function () {
									_this2.refs.wrap.style.boxShadow = '1px 1px 500px rgb(10,118,183)';
									_this2.refs.wrap.style.backgroundColor = 'rgba(10,118,183,.4)';
							}, 2000);
							setTimeout(function () {
									_this2.refs.wrap.style.boxShadow = '0px 0px 0px rgb(10,118,183)';
									_this2.refs.wrap.style.backgroundColor = 'rgba(10,118,183,0)';
							}, 2300);
					}
			}, {
					key: 'getIn',
					value: function getIn() {
							var row1s = document.getElementsByClassName('row1');
							var row2s = document.getElementsByClassName('row2');
					...
					value: function render() {
							return _react2.default.createElement(
									'div',
									{ ref: 'apps', className: 'apps animated fadeIn', style: { backgroundImage: 'url(../image/aim.jpg)' } },
									_react2.default.createElement(
											'div',
											{ className: 'container' },
											_react2.default.createElement('div', { ref: 'wrap', className: 'wrap' }),
											_react2.default.createElement(
													'div',
													{ ref: 'react',
															className: 'item row1',
											...
											_react2.default.createElement(
													'div',
													{ ref: 'calculator', className: 'item row1' },
													_react2.default.createElement(
															'h1',
															null,
											...
											_react2.default.createElement(
													'div',
													{ ref: 'timer', className: 'item row2' },
													_react2.default.createElement(
															'h1',
															null,
															'Pomodoro Timer Zipline'
													),
													_react2.default.createElement(
															'p',
															null,
											...
											_react2.default.createElement(
													'div',
													{ ref: 'weather', className: 'item row2' },
													_react2.default.createElement(
															'h1',
															null,
															'Weather App'
											...
											_react2.default.createElement(
													'div',
													{ ref: 'pacman', className: 'item row2' },
													_react2.default.createElement(
															'h1',
															null,
															'2048'
											...
											_react2.default.createElement(_nav2.default, { title: 'Apps', hrefAnimation: this.state.hrefAnimation })
									),
									this.props.children
							);
					}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./apps.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./apps.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".apps {\n  width: 100%;\n  height: 100%;\n  background-repeat: no-repeat;\n  background-size: 100%; }\n  .apps .container {\n    position: relative;\n    overflow: hidden;\n    width: 100%;\n    height: 100%; }\n    .apps .container .wrap {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      width: 940px;\n      height: 420px;\n      margin-top: -240px;\n      margin-left: -490px;\n      box-shadow: 0px 0px 0px #0a76b7;\n      background-color: rgba(10, 118, 183, 0);\n      transition: all 0.3s ease-in-out; }\n    .apps .container .row1 {\n      position: absolute;\n      top: 50%;\n      left: -400px;\n      margin-top: -240px; }\n    .apps .container .row2 {\n      position: absolute;\n      top: 50%;\n      right: -400px;\n      margin-top: -20px; }\n    .apps .container .item {\n      width: 300px;\n      height: 200px;\n      padding: 25px;\n      border-radius: 8px;\n      text-align: center;\n      cursor: pointer;\n      color: #fff;\n      background-color: rgba(0, 0, 0, 0.5);\n      transition: all 0.5s ease-in-out; }\n      .apps .container .item:hover {\n        box-shadow: 1px 1px 50px #0a76b7;\n        background-color: rgba(0, 0, 0, 0.8); }\n      .apps .container .item h1 {\n        margin-top: 30px;\n        font-size: 20px; }\n      .apps .container .item p {\n        margin-top: 30px;\n        font-size: 14px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./app.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./app.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloReact = (function (_React$Component) {
		...
		function HelloReact(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HelloReact).call(this, props));
		...
		_createClass(HelloReact, [{
			...
			value: function forward() {
				this.setState({ step: this.state.step < this.state.total ? this.state.step + 1 : this.state.total });
			}
		}, {
			key: 'backward',
			value: function backward() {
				this.setState({ step: this.state.step > 0 ? this.state.step - 1 : this.state.step });
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ ref: 'helloReact', className: 'hello-react animated lightSpeedIn' },
					_react2.default.createElement(
						'div',
						{ className: 'container' },
						_react2.default.createElement(
							'div',
							{ ref: 'process', className: 'process' },
							_react2.default.createElement('div', { ref: 'innerProcess', className: 'inner-process', style: { width: this.state.step / this.state.total * 100 + '%' } }),
							_react2.default.createElement(
								'div',
								{ className: 'step' },
								Math.floor(this.state.step / this.state.total * 100),
								'%'
							)
						),
						text.map(function (item) {
							return _react2.default.createElement(
								...
								{ key: item.step,
									...
									style: { display: _this2.state.step === item.step ? 'block' : 'none' }
								},
								_this2.state.language == 'En' ? item.en : item.cn
							);
						}),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'div',
								{ className: 'backward', onClick: this.backward.bind(this) },
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-step-backward' })
							),
							_react2.default.createElement(
								'div',
								{ className: 'forward', onClick: this.forward.bind(this) },
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-step-forward' })
							)
						),
						_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./helloReact.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./helloReact.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".hello-react {\n  width: 100%;\n  height: 100%;\n  background-color: #000; }\n  .hello-react .container {\n    position: relative;\n    overflow: hidden;\n    width: 100%;\n    height: 100%; }\n    .hello-react .container .section {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      width: 80%;\n      height: 500px;\n      margin-top: -300px;\n      margin-left: -40%;\n      text-indent: 2em;\n      font-size: 28px;\n      color: #f5f5f5; }\n      @media (max-height: 720px) {\n        .hello-react .container .section {\n          height: 400px;\n          margin-top: -250px;\n          font-size: 24; } }\n    .hello-react .container .buttons {\n      position: absolute;\n      bottom: 10px;\n      left: 0;\n      width: 100%;\n      height: 120px;\n      line-height: 120px;\n      text-align: center;\n      font-size: 30px;\n      color: #000; }\n      .hello-react .container .buttons .backward {\n        position: absolute;\n        top: 0;\n        left: 50%;\n        width: 60px;\n        height: 120px;\n        margin-left: -60px;\n        border-radius: 60px 0 0 60px;\n        cursor: pointer;\n        background-color: rgba(255, 255, 255, 0.5);\n        transition: all 0.3s ease-in-out; }\n        .hello-react .container .buttons .backward:hover {\n          background-color: rgba(255, 255, 255, 0.9); }\n      .hello-react .container .buttons .forward {\n        position: absolute;\n        top: 0;\n        left: 50%;\n        width: 60px;\n        height: 120px;\n        border-radius: 0 60px 60px 0;\n        cursor: pointer;\n        background-color: rgba(10, 118, 183, 0.5);\n        transition: all 0.3s ease-in-out; }\n        .hello-react .container .buttons .forward:hover {\n          background-color: rgba(10, 118, 183, 0.9); }\n    .hello-react .container .process {\n      overflow: hidden;\n      position: relative;\n      width: 80%;\n      height: 40px;\n      margin: 10px auto 0 auto;\n      border-radius: 15px;\n      background-color: rgba(255, 255, 255, 0.5); }\n      .hello-react .container .process .step {\n        position: absolute;\n        top: 0;\n        left: 50%;\n        line-height: 40px;\n        text-align: center;\n        color: #fff; }\n      .hello-react .container .process .inner-process {\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 0;\n        height: 40px;\n        background-color: #0a76b7;\n        transition: all 0.5s ease-in-out; }\n    .hello-react .container .language {\n      position: absolute;\n      bottom: 0;\n      left: 0;\n      width: 50px;\n      height: 50px;\n      line-height: 50px;\n      text-align: center;\n      font-size: 20px;\n      border-radius: 50%;\n      cursor: pointer;\n      color: #fff;\n      background-color: rgba(255, 255, 255, 0.5); }\n      .hello-react .container .language:hover {\n        color: #000;\n        background-color: #fff; }\n    .hello-react .container .back {\n      position: absolute;\n      bottom: 0;\n      right: 0;\n      width: 50px;\n      height: 50px;\n      line-height: 50px;\n      text-align: center;\n      font-size: 30px;\n      border-radius: 50%;\n      cursor: pointer;\n      color: #fff;\n      background-color: rgba(255, 255, 255, 0.5); }\n      .hello-react .container .back:hover {\n        color: #000;\n        background-color: #fff; }\n", ""]);
